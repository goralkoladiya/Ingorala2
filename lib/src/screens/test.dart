...
class SingleList extends StatefulWidget {
  ...
  String? surname;
  SingleList([this.surname]);

  @override
  State<SingleList> createState() => _MessagesWidgetState();
}

class _MessagesWidgetState extends State<SingleList> {
          ...
          FutureBuilder(
            builder: (context, snapshot) {
              if(snapshot.connectionState==ConnectionState.done)
              {
                ...
                {
                  return Center(child: CircularProgressIndicator(color: Color(0xff2D6064)),);
                }
