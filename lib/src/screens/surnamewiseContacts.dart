...
class SurnameWiseContacts extends StatefulWidget {

  String? surname;
  SurnameWiseContacts([this.surname]);

  @override
  State<SurnameWiseContacts> createState() => _SurnameWiseContactsState();
}

class _SurnameWiseContactsState extends State<SurnameWiseContacts> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text("Contacts - ${widget.surname}",style: Theme.of(context).textTheme.displayLarge,),
      ),
      body: Column(
        children: [
          Row(
              ...
              child: StreamBuilder<DatabaseEvent>(
                ...
                builder: (context, snapshot) {
                  ...
                  if(snapshot.hasData)
                  {
                    ...
                    {
                      allmembers=allmembers.where((element) => element.fullName!.toString().contains(widget.surname!)).toList();
                    }
                    return Column(
                      children: [
                        Expanded(
          ...
          //         if(widget.surname!=null)
          //         {
          //           members.result=members.result!.where((element) => element.fullName!.toString().contains(widget.surname!)).toList();
          //         }
          ...
          //                return ContactItemWidget(members.result![index]);
          //              },
          //                 itemCount: members.result!.length,
          //               ),
          //             )
          //           ],
          //         );
