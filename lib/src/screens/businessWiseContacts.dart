...
class BusinessWiseContacts extends StatefulWidget {

  String? category;
  BusinessWiseContacts([this.category]);

  @override
  State<BusinessWiseContacts> createState() => _BusinessWiseContactsState();
}

class _BusinessWiseContactsState extends State<BusinessWiseContacts> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
              ...
              child: StreamBuilder<DatabaseEvent>(
                ...
                builder: (context, snapshot) {
                  ...
                  if(snapshot.hasData)
                  {
                    ...
                    {
                      allmembers=allmembers.where((element) => element.businessCategory!.toString().contains(widget.category!)).toList();
                    }
                    return Column(
                      children: [
                        Expanded(
          ...
          //         if(widget.category!=null)
          //         {
          //           members.result=members.result!.where((element) => element.businessCategory!.toString().contains(widget.category!)).toList();
          //         }
