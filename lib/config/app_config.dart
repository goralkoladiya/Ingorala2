...
class Colors {
  Color _mainColor = Color(0xffFCFFE7);
  Color _mainDarkColor = Color(0xffFCFFE7);
  Color _secondColor = Color(0xff2D6064);//
  Color _secondDarkColor = Color(0xffBA5A2F);//
  Color _accentColor = Color(0xffFF9B70);
  Color _accentDarkColor = Color(0xffFF9B70);

  Color _textMainColor = Color(0Xff2D6064);
  // Color _textMainColor = Color(0Xff2B3467);
  Color _textSecondColor = Color(0xff2D6064);
  Color _textAccentColor = Color(0xffEB455F);
